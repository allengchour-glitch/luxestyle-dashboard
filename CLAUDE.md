...
- `tools/build_reel.py` — **Automatisierungs-Tool**: JSON-Konfig → fertiges gebrandetes 9:16-Reel/Ad (Blur-Fill, Branding, Ken-Burns, Transitions, Musik, End-Card). `python3 build_reel.py manifest.json`. Doku: `tools/README.md`.
